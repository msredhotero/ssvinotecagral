...
$lblreemplazo	= array("Clientes");

$resCliente		=	$serviciosReferencias->traerClientes();
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerLibros(),92);
