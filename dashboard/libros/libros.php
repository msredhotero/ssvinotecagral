...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerLibrosPorCliente($id),92);

$autorizacion = $serviciosReferencias->GUID();
$serviciosReferencias->insertarAutorizacion($autorizacion);
...
<h3><?php echo $plural; ?></h3>
    ...
    <div class="boxInfoLargo">
        <div id="headBoxInfo">
        	<p style="color: #fff; font-size:18px; height:16px;">Cargar Libros</p>
...
$(document).ready(function(){
	...
	$("#example").on("click",'.varborrarlibros', function(){
	...
	$("#example").on("click",'.varmodificarlibros', function(){
		  usersid =  $(this).attr("id");
		  if (!isNaN(usersid)) {
	...
	$("#example").on("click",'.vardescargar', function(){
		  ...
		  if (!isNaN(usersid)) {
			...
			url = "descargas.php?id=" + usersid + "&autorizacion=" + '<?php echo $autorizacion; ?>';
			$(location).attr('href',url);
		  } else {
			alert("Error, vuelva a realizar la acción.");	
		  }
