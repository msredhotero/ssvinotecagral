...
$cadRef 		=	$serviciosFunciones->devolverSelectBoxActivo($resCliente,array(1),'', mysql_result($resResultado,0,"refclientes"));
...
<div id="dialog3" title="Borrar Libro">
    	<p>
        	<span class="ui-icon ui-icon-alert" style="float: left; margin: 0 7px 20px 0;"></span>
            ¿Esta seguro de desea eliminar este libro?.
        </p>
        <div id="auxImg">
	...
	$( "#dialog3" ).dialog({
		...
		buttons: {
			"Eliminar": function() {
				...
				$.ajax({
							data:  {id: $("#idAgente").val(), accion: 'eliminarLibros'},
							url:   '../../ajax/ajax.php',
							type:  'post',
							beforeSend: function () {
