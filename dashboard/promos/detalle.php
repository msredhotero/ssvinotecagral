...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Promos",$_SESSION['refroll_predio'],'');


$id = $_GET['id'];

$resResultado = $serviciosReferencias->traerPromosPorId($id);


/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Detalle Promoción";

$plural = "Detalles Promoción";

$eliminar = "eliminarPromodetalle";

$insertar = "insertarPromodetalle";

$idTabla = "idpromodetalle";
...
$tabla 			= "dbpromodetalle";

$lblCambio	 	= array("refpromos","refproductos");
$lblreemplazo	= array("Promo","Producto");

$resPromos 	= $serviciosReferencias->traerPromosPorId($id);
$cadRef 	= $serviciosFunciones->devolverSelectBoxActivo($resPromos,array(1),'',$id);

$resProductos 	= $serviciosReferencias->traerProductos();
$cadRef2 	= $serviciosFunciones->devolverSelectBox($resProductos,array(3),'');

$refdescripcion = array(0 => $cadRef, 1=>$cadRef2);
$refCampo 	=  array("refpromos","refproductos");
//////////////////////////////////////////////  FIN de los opciones //////////////////////////
