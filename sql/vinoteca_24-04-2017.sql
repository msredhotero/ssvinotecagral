...
--
-- Servidor: localhost
-- Tiempo de generación: 24-04-2017 a las 11:30:36
...
(1, 1, 1, 12, '40.00', '480.00', 0),
(2, 1, 2, 6, '50.00', '300.00', 0);
...
--
-- Volcado de datos para la tabla `dbdetallepreventas`
--

INSERT INTO `dbdetallepreventas` (`iddetallepreventa`, `refventas`, `refproductos`, `cantidad`, `costo`, `precio`, `total`, `nombre`) VALUES
(1, 3, 2, '1.00', '0.00', '150.00', '150.00', 'wfewefw'),
(2, 3, 1, '3.00', '0.00', '120.00', '360.00', 'Toro Viejo Tinto'),
(3, 4, 2, '1.00', '0.00', '150.00', '150.00', 'wfewefw'),
(4, 4, 1, '3.00', '0.00', '120.00', '360.00', 'Toro Viejo Tinto'),
(5, 5, 2, '1.00', '0.00', '150.00', '150.00', 'wfewefw'),
(6, 5, 1, '2.00', '0.00', '120.00', '240.00', 'Toro Viejo Tinto');
...
--
-- Volcado de datos para la tabla `dbdetalleventas`
--

INSERT INTO `dbdetalleventas` (`iddetalleventa`, `refventas`, `refproductos`, `cantidad`, `costo`, `precio`, `total`, `nombre`) VALUES
(16, 11, 2, '1.00', '0.00', '150.00', '150.00', 'wfewefw'),
(17, 11, 1, '2.00', '0.00', '100.00', '200.00', 'Toro Viejo Tinto'),
(18, 12, 1, '1.00', '0.00', '120.00', '120.00', 'Toro Viejo Tinto'),
(19, 12, 2, '6.00', '0.00', '120.00', '720.00', 'wfewefw');
...
(1, '2017-04-24 00:00:00', '2017-04-30 00:00:00', '780.00', 3, '', '');
...
CREATE TABLE IF NOT EXISTS `dbproductos` (
  ...
  `deposito` varchar(120) DEFAULT NULL,
...
INSERT INTO `dbproductos` (`idproducto`, `codigo`, `codigobarra`, `nombre`, `stock`, `stockmin`, `preciocosto`, `precioventa`, `preciodescuento`, `utilidad`, `imagen`, `refcategorias`, `tipoimagen`, `unidades`, `descripcion`, `activo`, `refproveedores`, `deposito`) VALUES
(1, 'PRO000001', '111', 'Toro Viejo Tinto', 24, 4, '40.00', '120.00', '100.00', '80.00', '', 1, '', 1, '', b'1', 1, NULL),
(2, 'PRO000002', '777', 'wfewefw', 10, 6, '50.00', '150.00', '120.00', '100.00', '', 1, '', 1, '', b'1', 1, 'Galpon'),
(3, 'PRO000003', '444', 'beer', 8, 2, '20.00', '45.00', '40.00', '25.00', '', 1, '', 1, '', b'1', 1, 'Arriba del lado derecho');
...
INSERT INTO `dbventas` (`idventa`, `reftipopago`, `numero`, `fecha`, `total`, `usuario`, `cancelado`, `refclientes`, `descuento`) VALUES
(11, 1, 'CC00000001', '2017-04-24', '350.00', 'Saupurein Marcos', b'0', 1, '0.00'),
(12, 2, 'CC00000012', '2017-04-24', '840.00', 'Saupurein Marcos', b'0', 1, '50.00');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dbventasaux`
--

CREATE TABLE IF NOT EXISTS `dbventasaux` (
  `idventaaux` int(11) NOT NULL AUTO_INCREMENT,
  `reftipopago` int(11) NOT NULL,
  `numero` varchar(10) DEFAULT NULL,
  `fecha` date DEFAULT NULL,
  `total` decimal(18,2) DEFAULT NULL,
...
(15, '../categorias/', 'icozonas', 'Uvas', 8, NULL, 'Empleado, Administrador, SuperAdmin'),
